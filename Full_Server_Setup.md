...
alias compileopenssl='cd /home/$USER/openssl && ./Configure -d --prefix=/usr/local/openssl shared && export LD_LIBRARY_PATH="/home/$USER/openssl/" && make && sudo make install && openssl version'
...
alias compileapache='cd /home/$USER/byu-sandianl-apache && sudo /sbin/ldconfig -v /usr/local/openssl/lib64 && LDFLAGS=-L/usr/local/openssl/lib64 ./configure --with-ssl=/usr/local/openssl/lib64 --enable-ssl-staticlib-deps --enable-mods-static=ssl && make'
```
